...
create procedure Doggie(in name varchar(50))
BEGIN
declare momo int;
select DNI into momo from Duenio where D_nombre = name;
declare omom int;
select P_codigo into omom from perro where D_DNI = omom;
select * from adiestramiento where P_codigo = omom;
end
//

create function destro(in race varchar())